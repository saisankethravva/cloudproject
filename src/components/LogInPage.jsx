    ...
    return (
        ...
        backgroundColor: '#26A69A'}}>
                    ...
                    <Button  variant="primary" href="https://sanketh-dropbox.auth.us-west-1.amazoncognito.com/login?client_id=l5qirgu7eubs9btbr0s4o7e7t&response_type=token&scope=phone+email+openid+aws.cognito.signin.user.admin+profile&redirect_uri=http://localhost:3000/">
                        LogIn / SignUp  { <a href="https://sanketh-dropbox.auth.us-west-1.amazoncognito.com/login?client_id=l5qirgu7eubs9btbr0s4o7e7t&response_type=token&scope=phone+email+openid+aws.cognito.signin.user.admin+profile&redirect_uri=http://localhost:3000/"></a> }
                    </Button>
                </Card.Body>
            </Card>
            </div>
